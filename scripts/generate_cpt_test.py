#!/usr/bin/env python3
"""Generate isolated factual-completion probes for Experiment 2 CPT records."""
...
from data.cpt_test import generate_exp2_cpt_test
from utils.paths import EXP02_QA_DIR
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "the exact independent records used for Experiment-2 CPT."
        )
    )
...
def main() -> None:
    ...
    output_dir = EXP02_QA_DIR / training_data_dir.name / "cpt_test"
    result = generate_exp2_cpt_test(
        config,
